...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  getWindowState: () => ipcRenderer.invoke('hermes:window-state'),
  ...
  DAOAuth: {
    getToken: () => ipcRenderer.invoke('hermes:DAO-auth:get-token'),
    setToken: token => ipcRenderer.invoke('hermes:DAO-auth:set-token', token),
    clearToken: () => ipcRenderer.invoke('hermes:DAO-auth:clear-token'),
    oauthLogin: payload => ipcRenderer.invoke('hermes:DAO-auth:oauth-login', payload)
  },
