...
export const ja = defineLocale({
  ...
  boot: {
    ...
    failure: {
      ...
      DAOTitle: 'DAO API サイドカーに接続できません',
      DAODescription:
        'チャットは DAO API サイドカー（ポート 9119）経由で WebSocket セッションを確立します。サイドカーを起動し、正常化後に再試行してください。',
      DAOSidecarHint: sidecar =>
        `サイドカーは ${sidecar} で待機している想定です。リポジトリルートで ./scripts/dev-desktop.sh または ./scripts/dev-desktop.sh --sidecar を実行してください。`,
      DAORetrySidecar: '再接続',
  ...
  titlebar: {
    ...
    shortcutsGroup: 'サウンドとキーボード',
    openSettings: 'アプリ設定',
    openKeybinds: 'キーボードショートカット',
    openKnowledge: '会社ナレッジを開く'
  },
  ...
  settings: {
    ...
    about: {
      ...
      poweredByHermes: 'Powered by Hermes',
    ...
    toolsets: {
      ...
      ready: '準備完了',
      nousIncluded: 'DAO Cloud に含まれています。有効にするにはサインインしてください。',
  ...
  skills: {
    pageTitle: 'スキルとツール',
    pageDesc: 'エージェントが使える機能 — 新しいセッションに適用する項目を切り替えます。',
    tabSkills: 'スキル',
    tabToolsets: 'ツールセット',
    navSections: 'スキルセクション',
    filterCategories: 'スキルカテゴリ',
    all: 'すべて',
    searchSkills: 'スキルを検索...',
  ...
  messaging: {
    pageTitle: 'メッセージング',
    pageDesc: 'チャットプラットフォームを接続して、スペースでメッセージを送受信します。',
    platformsLabel: 'プラットフォーム',
    poweredByHermes: 'Powered by Hermes',
    filterPlatforms: 'プラットフォームフィルター',
    filterAll: 'すべて',
    filterEnabled: '有効',
    filterNeedsSetup: 'セットアップが必要',
    search: 'メッセージングを検索...',
    ...
    noMatchTitle: 'プラットフォームが見つかりません',
    noMatchDesc: '別の検索語またはフィルターをお試しください。',
    fieldCopy: {
      TELEGRAM_BOT_TOKEN: {
        label: 'ボットトークン',
  ...
  artifacts: {
    pageTitle: 'アーティファクト',
    pageDesc: '最近のセッションで生成された画像・ファイル・リンク。',
    search: 'アーティファクトを検索...',
    refresh: 'アーティファクトを更新',
    refreshing: 'アーティファクトを更新中',
    indexing: '最近のセッションのアーティファクトをインデックス中',
    navSections: 'アーティファクトの種類',
    tabAll: 'すべて',
    tabImages: '画像',
    tabFiles: 'ファイル',
    tabLinks: 'リンク',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'DAO が応答を読み込み中',
      thinking: '考え中',
      stallThinking: 'DAO が考え中',
      today: time => `今日 ${time}`,
