...
export const en: Translations = {
  ...
  boot: {
    ready: 'DAO OS is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading DAO settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting DAO OS…'
    },
    errors: {
      backgroundExited: 'Agent runtime (Hermes) exited.',
      backgroundExitedDuringStartup: 'Agent runtime (Hermes) exited during startup.',
    ...
    failure: {
      title: "DAO couldn't start",
      description:
        "The background gateway didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      DAOTitle: "DAO API sidecar unreachable",
      DAODescription:
        'Chat connects to the DAO API sidecar (port 9119) for WebSocket sessions. Start the sidecar or retry once it is healthy.',
      DAOSidecarHint: sidecar =>
        `Sidecar expected at ${sidecar}. Run ./scripts/dev-desktop.sh or ./scripts/dev-desktop.sh --sidecar in the repo root.`,
      DAORetrySidecar: 'Retry connection',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Hermes runtime is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting DAO Desktop.',
  ...
  titlebar: {
    ...
    shortcutsGroup: 'Sound & keyboard',
    openSettings: 'App preferences',
    openKeybinds: 'Keyboard shortcuts',
    openKnowledge: 'Open company knowledge'
  },
  ...
  keybinds: {
    ...
    actions: {
      ...
      'nav.settings': 'Open app preferences',
  ...
  settings: {
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let DAO follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'DAO checks for updates automatically in the background and lets you know when one is ready.',
    ...
    gateway: {
      ...
      intro:
        'DAO Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Hermes runtime on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private agent backend on localhost (Hermes runtime). This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote agent backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'DAO Desktop will reconnect using the saved settings.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. DAO runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with DAO Cloud — sign in to activate.',
  ...
  skills: {
    ...
    pageDesc: 'Capabilities your agents can use — toggle what applies to new sessions.',
    tabSkills: 'Skills',
    tabToolsets: 'Toolsets',
    navSections: 'Skills sections',
    filterCategories: 'Skill categories',
    all: 'All',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure DAO desktop' },
    ...
    hermesActiveSessions: (version, count) =>
      `DAO agent · ${count} sessions${version ? ` · Hermes ${version}` : ''}`,
  ...
  messaging: {
    pageTitle: 'Messaging',
    pageDesc: 'Connect chat platforms so your space can send and receive messages.',
    platformsLabel: 'Platforms',
    poweredByHermes: 'Powered by Hermes',
    filterPlatforms: 'Platform filters',
    filterAll: 'All',
    ...
    noMatchTitle: 'No platforms found',
    noMatchDesc: 'Try a different search term or filter.',
    fieldCopy: {
      TELEGRAM_BOT_TOKEN: {
        label: 'Bot token',
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent DAO agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. DAO will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting DAO agent...',
    placeholderReconnecting: 'Reconnecting to DAO agent…',
    ...
    attachUrlDesc: 'DAO will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of DAO can’t update the Hermes runtime from inside the app.',
    ...
    availableBody: 'A new version of DAO is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Hermes runtime is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed the Hermes runtime from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'DAO will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Hermes updater will take over in its own window and reopen DAO when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. DAO reconnects automatically when it’s back.',
    applyingClose: 'DAO will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'DAO OS needs a one-time install',
    ...
    settingUpTitle: 'Setting up DAO OS',
    ...
    activeDesc:
      'This is a one-time setup. The DAO installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you set up with DAO OS",
    headerDesc: 'Connect a model provider to start chatting with your AI Lead.',
    preparingInstall: 'DAO OS is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting DAO OS…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run DAO',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point DAO at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — DAO connects automatically',
      loopback: 'Opens your browser to sign in — DAO connects automatically',
    ...
    authorizeThere: 'Authorize DAO there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize DAO there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `DAO Desktop v${version}`,
      ...
      gatewayTitle: 'Agent gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. DAO will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'DAO is restarting...',
      askRestart: 'Ask DAO to restart the server',
      lookingRestart: taskId => `DAO is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'DAO is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `DAO finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'DAO could not restart the server.',
      stillWorking:
        'DAO is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'DAO is loading a response',
      thinking: 'Thinking',
      stallThinking: 'DAO is thinking',
    ...
    approval: {
      gatewayDisconnected: 'DAO agent is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). DAO won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'DAO needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'DAO needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart DAO Desktop to use Save Image.',
    restartToSaveImages: 'Restart DAO Desktop to save images',
