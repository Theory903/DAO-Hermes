...
export const zh: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      DAOTitle: 'DAO API 侧车不可达',
      DAODescription: '聊天通过 DAO API 侧车（端口 9119）建立 WebSocket 会话。请先启动侧车，健康后再重试。',
      DAOSidecarHint: sidecar => `侧车应在 ${sidecar}。在仓库根目录运行 ./scripts/dev-desktop.sh 或 ./scripts/dev-desktop.sh --sidecar。`,
      DAORetrySidecar: '重试连接',
  ...
  titlebar: {
    ...
    shortcutsGroup: '声音与键盘',
    openSettings: '应用偏好设置',
    openKeybinds: '键盘快捷键',
    openKnowledge: '打开公司知识库'
  },
  ...
  settings: {
    ...
    toolsets: {
      ...
      ready: '就绪',
      nousIncluded: '包含在 DAO Cloud 中；登录即可激活。',
  ...
  skills: {
    pageTitle: '技能与工具',
    pageDesc: '智能体可使用的能力 — 切换适用于新会话的项目。',
    tabSkills: '技能',
    tabToolsets: '工具集',
    navSections: '技能分区',
    filterCategories: '技能分类',
    all: '全部',
    searchSkills: '搜索技能…',
