...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    failure: {
      ...
      DAOTitle: 'DAO API sidecar 無法連線',
      DAODescription: '聊天透過 DAO API sidecar（連接埠 9119）建立 WebSocket。請先啟動 sidecar，健康後再重試。',
      DAOSidecarHint: sidecar =>
        `Sidecar 應在 ${sidecar}。於 repo 根目錄執行 ./scripts/dev-desktop.sh 或 ./scripts/dev-desktop.sh --sidecar。`,
      DAORetrySidecar: '重試連線',
  ...
  titlebar: {
    ...
    shortcutsGroup: '聲音與鍵盤',
    openSettings: '應用偏好設定',
    openKeybinds: '鍵盤快捷鍵',
    openKnowledge: '開啟公司知識庫'
  },
  ...
  settings: {
    ...
    toolsets: {
      ...
      ready: '就緒',
      nousIncluded: '包含在 DAO Cloud 中；登入即可啟用。',
  ...
  skills: {
    pageTitle: '技能與工具',
    pageDesc: '智能體可使用的能力 — 切換適用於新工作階段的項目。',
    tabSkills: '技能',
    tabToolsets: '工具集',
    navSections: '技能分區',
    filterCategories: '技能分類',
    all: '全部',
    searchSkills: '搜尋技能...',
  ...
  messaging: {
    pageTitle: '訊息',
    pageDesc: '連接聊天平台，讓你的空間收發訊息。',
    platformsLabel: '平台',
    poweredByHermes: 'Powered by Hermes',
    filterPlatforms: '平台篩選',
    filterAll: '全部',
    filterEnabled: '已啟用',
    filterNeedsSetup: '待設定',
    search: '搜尋訊息平台…',
    loading: '正在載入訊息平台…',
    loadFailed: '訊息平台載入失敗',
    states: {
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'DAO 正在載入回覆',
      stallThinking: 'DAO 正在思考',
      thinking: '思考中',
      today: time => `今天，${time}`,
