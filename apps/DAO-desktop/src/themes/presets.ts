...
/** DAO VOID — absolute black void with Phantom lavender accents. */
export const voidTheme: DesktopTheme = {
  name: 'void',
  label: 'VOID',
  description: 'Absolute black void with Phantom lavender accents — DAO OS',
  colors: {
    background: '#000000',
    foreground: '#ffffff',
    card: '#0a0a0a',
...
export const DEFAULT_SKIN_NAME = 'void'
