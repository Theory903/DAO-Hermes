...
describe('onboarding Picker', () => {
  it('features DAO Cloud and hides other providers behind a disclosure', () => {
    setProviders([provider('anthropic', 'Anthropic Claude'), provider('nous', 'Nous Portal')])
    render(<Picker ctx={ctx} />)

    expect(screen.getByText('DAO Cloud')).toBeTruthy()
  ...
  it('shows every provider directly when DAO Cloud is absent', () => {
