...
import { PoweredByHermes } from '@/components/DAO/PoweredByHermes'
import { DAO_WORDMARK } from '@/lib/DAO-branding'
...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should DAO look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} DAO need to see?`,
    ...
    {
      headline: `What should ${label} DAO tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        ...
        <PoweredByHermes className="mb-3" />
