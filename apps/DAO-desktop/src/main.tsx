...
import './styles/void-dark.css'
import './features/DAO/styles/DAO-util-pages.css'
...
import { installBrowserHermesBridge } from './lib/browser-hermes-bridge'
import { assertDAOApiConfigured } from './lib/DAO-config'
import { installClipboardShim } from './lib/clipboard'
import { queryClient } from './lib/query-client'
import { ThemeProvider } from './themes/context'

installBrowserHermesBridge()
installClipboardShim()
assertDAOApiConfigured()
