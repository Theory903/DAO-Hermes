...
const SIDEBAR_VOICE_OPEN_STORAGE_KEY = 'hermes.desktop.sidebarVoiceOpen'
...
// Home-screen voice conversations get their own collapsible section below
// recents, expanded by default so a freshly-saved voice chat is visible.
export const $sidebarVoiceOpen = atom(storedBoolean(SIDEBAR_VOICE_OPEN_STORAGE_KEY, true))
...
$sidebarVoiceOpen.subscribe(open => persistBoolean(SIDEBAR_VOICE_OPEN_STORAGE_KEY, open))
...
export function setSidebarVoiceOpen(open: boolean) {
  $sidebarVoiceOpen.set(open)
}
