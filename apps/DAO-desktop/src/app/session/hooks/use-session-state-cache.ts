...
import { runtimeIdByStoredSessionId, sessionStateByRuntimeId } from '../session-state-registry'
...
export function useSessionStateCache({
  ...
  const runtimeIdByStoredSessionIdRef = useRef(runtimeIdByStoredSessionId)
